...
function Investisseurs({ isOpen, onClose, username, loadworld,}: InvestisseursProps) {
    ...
    let Anges = Math.round(Math.sqrt(loadworld.score / Math.pow(10, 15))*150 - loadworld.totalangels);
...
return(
    ...
    <div className="custom-modal-header">
      ...
      <div>
                        <div className="infosinvestisseurs">
                            <div className="angestotal">Anges actifs : {loadworld.activeangels}</div>
                        ...
                        <div>
                            <button className="button-reset" onClick={() => { resetWorld(); window.location.reload(); }}>
                                Recommencer avec {Anges} nouveaux anges en plus pour aller encore plus loin?
                            </button>
                        </div>
                    </div>
                </div>
